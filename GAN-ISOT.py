...
LEARNING_RATE = 1e-3
LATENT_DIM = 100
DATA_DIR = r"D:\Data\isot_Malware_images"
...
def train_gan(generator, discriminator, dataloader, optimizer_G, optimizer_D, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        print(
            f"Epoch [{epoch + 1}/{num_epochs}] Generator Loss: {g_loss_epoch / len(dataloader):.6f} | Discriminator Loss: {d_loss_epoch / len(dataloader):.6f}")
...
if __name__ == "__main__":
    ...
    output_folder = "ISOT_Malware_images_synthetic_GAN"
