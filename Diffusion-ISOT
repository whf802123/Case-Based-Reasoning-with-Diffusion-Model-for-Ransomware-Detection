...
betas = torch.linspace(1e-4, 0.005 * (1000 / T), T, device=DEVICE)
alphas = 1 - betas
...
if __name__ == "__main__":
    ...
    output_folder = "ISOT_Malware_images_synthetic"        # USTC_Benign_images_synthetic   USTC_Malware_images_synthetic          ISOT_Benign_images_synthetic   ISOT_Malware_images_synthetic
